...
function SubCategoryArabic() {
  ...
  useEffect(() => {
    const getCategory = async () => {
      try {
        const res = await axios.get(
            `http://localhost:5000/api/catigoriesArabic/find?category=${cat}`
        );
    ...
    <div className="travelDesc" dir="rtl">
      ...
      <p className="categoryp">{Category.desc8}</p>
      </div>
    </div>
    </div>
  ...
  export default SubCategoryArabic;